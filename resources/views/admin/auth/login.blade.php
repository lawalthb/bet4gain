    ...
    <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow">
        ...
        <form class="mt-8 space-y-6" action="{{ route('admin.login') }}" method="POST">
            ...
            <div>
                ...
                <input type="password" name="password" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" style="border: 1px solid #ccc;  font-size: 16px; border-radius: 5px; padding: 5px;">
            </div>
