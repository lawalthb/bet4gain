...
class UpdateSure extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'pusher:sure';
  ...
  public function handle()
  {
    ...
    $newAppId = Setting::get("pusher_app_id_5");
    $newKey = Setting::get("pusher_key_5");
    $newSecret = Setting::get("pusher_secret_5");
    $newEmail = Setting::get("pusher_email_5");
    ...
    Setting::updateOrCreate(['key' => 'active_pusher_set'], ['value' => 5]);

    $this->info("Switched to Pusher credentials set sure");
  }
}
